...
#
# Bash examples:
#   python pal_v5_mongo.py ingest '{"entity":"truck_17","event_type":"shipment","location":"taipei","status":"delayed","note":"flat tire"}'
#   python pal_v5_mongo.py plan "Compare delayed shipments in Taipei vs blocked shipments in Tainan"
#   python pal_v5_mongo.py plan "Compare truck_17 with truck_22"
#   python pal_v5_mongo.py plan "Analyze delayed events in Taipei and compare them with all events in Kaohsiung"
#
# Requirements:
#   pip install openai
...
def print_usage() -> None:
    print(
        "Usage:\n"
        "  python pal_v5_mongo.py ingest '<json_event>'\n"
        "  python pal_v5_mongo.py analyze\n"
        "  python pal_v5_mongo.py query '<json_filter>'\n"
        "  python pal_v5_mongo.py ask '<natural language query>'\n"
        "  python pal_v5_mongo.py plan '<natural language analysis request>'\n\n"
        "Bash examples:\n"
        '  python pal_v5_mongo.py ingest \'{"entity":"truck_17","event_type":"shipment","location":"taipei","status":"delayed","note":"flat tire"}\'\n'
        '  python pal_v5_mongo.py ask "show delayed events in taipei"\n'
        '  python pal_v5_mongo.py plan "Compare delayed shipments in Taipei vs blocked shipments in Tainan"\n'
        '  python pal_v5_mongo.py plan "Compare truck_17 with truck_22"\n'
    )
