# cursor_07_n8n_ingest.py
#
# 3.7 -- gmail + n8n webhook sensor stream
#
# Purpose:
...
#
# Commands:
#   python cursor_07_n8n_ingest.py reset
#   python cursor_07_n8n_ingest.py fetch
#   python cursor_07_n8n_ingest.py show
#   python cursor_07_n8n_ingest.py loop --interval 60
#   python cursor_07_n8n_ingest.py serve --port 8080
#
# Example:
